...
/**
 * As an organizer, notify entrants on the cancelled-entrants screen (same lottery notification
 * flow as SelectedList.notifyChosenEntrants() for CANCELLED / DECLINED entries).
 */
@RunWith(AndroidJUnit4.class)
@LargeTest
public class OrganizerCancelledListNotifyIntentTest {
    ...
    private static final String EVENT_ID = "test_event_cancelled_list_notify_intent";
    private static final String ENTRANT_ID = "test_entrant_cancelled_list_notify";
    ...
    public void setUp() throws Exception {
        ...
        event.put("title", "Cancelled List Notify Test");
        event.put("organizerId", "test_org_cancelled_notify");
        ...
        user.put("fullName", "Cancelled List Notify User");
        ...
        waiting.put("status", WaitingListEntry.Status.CANCELLED.name());
    ...
    @Test
    public void cancelledList_notifyButton_createsLotteryWinNotification() throws Exception {
        ...
        onView(withId(R.id.buttonNotifyCancelled)).perform(click());

        waitUntilNotificationExists(ENTRANT_ID, EVENT_ID, NotificationHelper.TYPE_CANCELLED_ENTRANT_REJOIN, 20, 400);
    }
