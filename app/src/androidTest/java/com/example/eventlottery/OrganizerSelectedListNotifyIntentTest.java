...
/**
 * As an organizer, send notifications to all selected entrants (SELECTED status).
 */
@RunWith(AndroidJUnit4.class)
@LargeTest
public class OrganizerSelectedListNotifyIntentTest {
    ...
    private static final String EVENT_ID = "test_event_selected_notify_intent";
    private static final String ENTRANT_ID = "test_entrant_selected_notify";
    ...
    public void setUp() throws Exception {
        ...
        event.put("title", "Selected Notify Test");
        event.put("organizerId", "test_org_selected_notify");
        ...
        user.put("fullName", "Selected Notify User");
    ...
    @Test
    public void selectedList_notifyChosenButton_createsLotteryWinNotification() throws Exception {
        ...
        onView(withId(R.id.buttonNotifySelected)).check(matches(isDisplayed()));

        InstrumentationRegistry.getInstrumentation().waitForIdleSync();
        Thread.sleep(2500);

        onView(withId(R.id.buttonNotifySelected)).perform(click());

        waitUntilNotificationExists(ENTRANT_ID, EVENT_ID, NotificationHelper.TYPE_LOTTERY_WON, 20, 400);
    }
